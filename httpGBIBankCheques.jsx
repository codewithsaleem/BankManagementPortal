...
class Cheques extends Component {
    ...
    async fetchData() {
        ...
        let response = null;
        if (searchString) {
            response = await http.get(`/getAllCheques?${searchString}`);
        }
        else {
            response = await http.get("/getAllCheques?page=1");
        ...
        return (
            <div className="container mt-3">
                <div className="jumbotron">
                    <h3 className="text-center">All Cheque Transactions</h3>
